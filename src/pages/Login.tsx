...
import { ShieldCheck, Lock, User, LayoutGrid, Mail, BadgeCheck, Briefcase, X } from "lucide-react";
...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (empCode === "Sahil@syncwork" && password === "admin123") {
      localStorage.setItem("auth_token", "dummy-admin-token");
      localStorage.setItem("user_role", "ADMIN");
      localStorage.setItem("user_id", "1");
      
      toast.success("SyncWork: Welcome Boss! 👑", { 
     ...
     if (empCode === "Rudra@syncwork" && password === "admin123") {
      localStorage.setItem("auth_token", "dummy-admin-token");
      localStorage.setItem("user_role", "ADMIN");
      localStorage.setItem("user_id", "1");
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(`Welcome to SyncWork!`, { 
          style: { background: '#2563eb', color: '#416190' } 
        });
        
        setTimeout(() => { window.location.href = "/dashboard"; }, 1000);
      } else {
        toast.error("Invalid Username or Password!", {
          style: { background: '#7763cf', color: '#ef4444', border: '1px solid #fecaca' }
        });
        setLoading(false);
      }
    } catch (error) {
  ...
  const handleRequestAccess = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Mock: Access request sent to syncwork0@gmail.com!", { 
        style: { background: '#10b981', color: '#fff' } 
      });
      setShowModal(false);
    } finally {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden font-sans relative">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#020617] relative flex-col justify-between p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="text-3xl font-black tracking-tight">SyncWork</span>
        </div>
        ...
        <div className="relative z-10 mb-20">
          ...
          <h2 className="text-7xl font-black leading-[1.1] tracking-tighter mb-8">
            Manage your <br /> 
      ...
      <div className="w-full lg:w-1/2 bg-cyan flex flex-col items-center justify-center p-8 lg:p-24 relative">
        
        <div className="w-full max-w-md space-y-10">
          <div className="space-y-3">
            <h1 className="text-4xl font-black tracking-tight bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
              Welcome Back
            </h1>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input 
                  ...
                  className="h-14 bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 rounded-2xl pl-12 font-bold text-lg focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all outline-none" 
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input 
                  ...
                  className="h-14 bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 rounded-2xl pl-12 pr-12 font-bold text-lg tracking-widest focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all outline-none" 
                />
              </div>
            </div>
          ...
          <div className="flex flex-col items-center gap-6 pt-4">
             ...
             <div className="pt-8 border-t border-slate-100 w-full text-center">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                  Developed by Sahil Sepat & Rudra Tiwari
                </p>
             </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl p-8 relative animate-in fade-in zoom-in duration-200">
            ...
            <button 
              ...
              className="absolute right-6 top-6 text-slate-400 hover:text-slate-700 bg-slate-100 hover:bg-slate-200 p-2 rounded-full transition-all"
            >
              <X className="w-5 h-5" />
            </button>

            <div className="space-y-2 mb-8">
              <h3 className="text-2xl font-black text-slate-900 tracking-tight">Request Access</h3>
            ...
            <form onSubmit={handleRequestAccess} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <Input 
                    ...
                    placeholder="Name" 
                    className="h-12 bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 rounded-xl pl-11 font-semibold focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all outline-none" 
                  />
                </div>
              </div>
              ...
              <Button 
                type="submit" 
                disabled={reqLoading}
                className="w-full h-12 mt-4 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-black text-md shadow-lg shadow-slate-900/20 transition-all active:scale-95"
              >
